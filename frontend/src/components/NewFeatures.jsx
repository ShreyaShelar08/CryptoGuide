  ...
  const features = [
    {
      ...
      subtitle: 'Your learning path, built by AI',
      desc: 'After answering 2 quick questions, the agent generates a custom week-by-week learning roadmap tailored to your goal and experience level. No generic courses — just what you actually need.',
      bullets: [
        ...
        '⚡ Powered by multi-step reasoning',
      ],
      color: '#6366f1',
